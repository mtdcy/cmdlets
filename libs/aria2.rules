...
libs_dep=(zlib libxml2 sqlite)
# aria2 并不支持 mbedtls, 所以不得不用 openssl, 所以移除依赖 mbedtls 的库
...
libs_args=(
    ...
    --without-libnettle
    --without-libgcrypt
    --without-libssh2  # sftp, built with mbedtls
...
libs_build() {
    ...
    cmdlet.install ./src/aria2c

    cmdlet.verify -- aria2c -v
}
